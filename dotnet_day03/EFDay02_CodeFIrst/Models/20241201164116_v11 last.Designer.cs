...
namespace EFDay02_CodeFIrst.Models
{
    ...
    [Migration("20241201164116_v11 last")]
    partial class v11last
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EFDay02_CodeFIrst.Models.Author", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            id = 1,
                            bref = "3",
                            joinDate = new DateTime(2001, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            name = "abood",
                            password = "hamada123",
                            username = "hamada"
                        });
            ...
            modelBuilder.Entity("EFDay02_CodeFIrst.Models.News", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CatalogId = 1,
                            bref = "m4 3aref",
                            datetime = new DateTime(2005, 5, 5, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            desc = "eh dh",
                            title = "3enwan"
                        });
                });
